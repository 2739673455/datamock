...
def counts(
    row: dict[str, Any] | None, total: str, first: str, second: str
) -> dict[str, int]:
    data = row or {}
    return {
...
@router.get("/me/cohorts", summary="分页查询我的班次")
def list_my_cohorts(
...
@router.get("/me/cohorts/{cohort_id}", summary="查询我的班次详情")
...
@router.get("/me/cohorts/{cohort_id}/sessions", summary="查询我的班次课次")
...
@router.get("/me/cohorts/{cohort_id}/progress", summary="查询我的班次学习进度")

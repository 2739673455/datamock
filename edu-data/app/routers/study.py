...
@router.get("/sessions/{session_id}", summary="查询课次详情")
...
@router.get("/videos/{video_id}", summary="查询视频详情")
...
@router.get("/videos/{video_id}/chapters", summary="查询视频章节")
...
@router.get("/me/video-history", summary="分页查询我的视频学习记录")
...
@router.get("/me/homeworks", summary="分页查询我的作业")
def list_my_homeworks(
    current_user_id: Annotated[int, Depends(get_current_user_id)],
    status: Annotated[
        str | None,
        Query(
            description="作业状态。可选值：pending、submitted、expired_unsubmitted。"
        ),
    ] = None,
    cohort_id: Annotated[
        int | None, Query(alias="cohortId", description="班次 ID。")
    ] = None,
    due_before: Annotated[
        str | None,
        Query(
            alias="dueBefore", description="截止时间上限，格式：YYYY-MM-DD HH:mm:ss。"
        ),
    ] = None,
    page_no: Annotated[int, Query(alias="pageNo", description="页码，从 1 开始。")] = 1,
    page_size: Annotated[
    ...
    conditions = [
        "rel.user_id = %s",
        "rel.enroll_status NOT IN ('cancelled', 'refunded')",
    ]
...
@router.get("/homeworks/{homework_id}", summary="查询作业详情")
...
@router.get("/me/homework-submissions", summary="分页查询我的作业提交记录")
...
@router.get("/me/exams", summary="分页查询我的考试")
def list_my_exams(
    current_user_id: Annotated[int, Depends(get_current_user_id)],
    status: Annotated[
        str | None,
        Query(
            description="考试状态。可选值：not_started、in_progress、submitted、absent、timeout。"
        ),
    ] = None,
    cohort_id: Annotated[
        int | None, Query(alias="cohortId", description="班次 ID。")
    ...
    deadline_before: Annotated[
        str | None,
        Query(
            alias="deadlineBefore",
            description="截止时间上限，格式：YYYY-MM-DD HH:mm:ss。",
        ),
    ] = None,
    page_no: Annotated[int, Query(alias="pageNo", description="页码，从 1 开始。")] = 1,
    page_size: Annotated[
    ...
    return ok(
        {
            "list": [exam_payload(row) for row in rows],
            "pageNo": page_no,
            "pageSize": page_size,
            "total": total,
        }
...
@router.get("/exams/{exam_id}", summary="查询考试详情")
def get_exam_detail(
...
@router.get("/me/exam-submissions", summary="分页查询我的考试提交记录")
def list_my_exam_submissions(
    current_user_id: Annotated[int, Depends(get_current_user_id)],
    status: Annotated[
        str | None,
        Query(
            description="考试作答状态。可选值：not_started、in_progress、submitted、absent、timeout。"
        ),
    ] = None,
    page_no: Annotated[int, Query(alias="pageNo", description="页码，从 1 开始。")] = 1,
    page_size: Annotated[
